...
public class C02_BeforeAfterNotasyonlari {
    /*
        ...
        @Test method'larinda CAGIRMAYA GEREK OLMADAN o method her test method'undan once calisir,

        Ayni sekilde her test Method'undan sonra calismasini istedigimiz siradan bir method varsa
    ...
    public void youtubeTesti() {
        ...
        if (actualTitle.contains(unexpectedTitleIcerik)) {
            System.out.println("Youtube testi FAİLED");
        } else {
