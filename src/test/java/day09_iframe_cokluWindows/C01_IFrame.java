...
public class C01_IFrame extends TestBase {
    ...
    public void test01(){
       ...
       // - Text Box’a “Merhaba Dunya!” yazin.
        ...
        driver.switchTo().frame(iframe);//bu şekilde iframe gecis yapmis olduk
       ...
       // iframe'e gecen driver'i yeniden anasayfaya yani bir ust katmana
       // (matruskanın icinden bir ust matruskaya gecirmek icin aşagidaki gibi apmamiz gerekir
        driver.switchTo().defaultContent();

        WebElement elementalLinki = driver.findElement(By.linkText("Elemental Selenium"));
        Assert.assertTrue(elementalLinki.isEnabled());
